			...
			<div class="board_list">
				<div class="tab">
					<v-tabs fixed-tabs>
						...
						<v-tab>Python <span>00</span></v-tab>
						<v-tab>R <span>00</span></v-tab>
						<v-tab>Anaconda <span>00</span></v-tab>
				...
				<div class="list">
					...
					<div class="card_board">
						<div style="display: flex; flex-basis: 33.3%">
							<v-card
								style="
									width: 342px;
									height: 335px;
							...
							>
								...
								<v-card-title
									>zull-core 제목표시 한줄</v-card-title
								>
								<v-card-subtitle
									>Version : 1.3.1 버전정보는
									한줄</v-card-subtitle
							...
							<v-card style="width: 342px; height: 335px">
								<v-card-text>
									<v-chip-group
										active-class="deep-purple accent-4 white--text"
										column
