			...
			<div class="item_box">
				<div class="table_box">
					<table class="tb_write">
						...
						<tbody>
							<tr>
								<th>구분 <span class="asterisk">필수</span></th>
								<td>
									<v-select
							...
							<tr>
								<th>질문 <span class="asterisk">필수</span></th>
								<td>
									<v-text-field
...
export default {
	data() {
		return {
			...
			rules: {
				category_rules: value => !!value || '카테고리를 선택해 주세요.',
				questions_rule: value => !!value || '질문을 입력해 주세요.',
			},
		}
	},
	watch: {
