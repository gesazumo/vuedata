	...
	<div class="adm_contents">
		<div class="inner">
			...
			<div style="width: 500px">
				<!--사용률 linear-->
				<v-progress-linear v-model="linear1" color="green" height="20">
					<strong>{{ Math.ceil(linear1) }}%</strong>
				</v-progress-linear>
				<br />
				<v-progress-linear v-model="linear2" color="green" height="20">
					<strong>{{ Math.ceil(linear2) }}%</strong>
				</v-progress-linear>
				<br />
				<v-progress-linear v-model="linear3" color="red" height="20">
